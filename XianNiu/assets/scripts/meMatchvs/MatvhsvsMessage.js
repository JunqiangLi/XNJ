...
var msg = {
    ...
    MATCHVS_INIT : "MATCHVS_INIT",  //初始化
    MATCHVS_REGISTER_USER:"MATCHVS_REGISTER_USER", //注册
    ...
    MATCHV_GANESERVER_NOTIFY : "MATCHVS_GAMESERVER_NOTIFY",
    MATCHVS_FRAME_UPDATE : "MATCHVS_FRAME_UPDATE",
    MATCHVS_WX_BINDING: "MATCHVS_WX_BINDING",
    MATCHVS_NETWORK_STATE_NOTIFY: "MATCHVS_NETWORK_STATE_NOTIFY",  //网络监听
    MATCHVS_LOGOUT: "MATCHVS_LOGOUT",
    MATCHVS_NETWORKSTATE :"MATCHVS_NETWORKSTATE",  //网络监听
    MATCHVS_ERROR : "MATCHVS_ERROR",               //错误
